...
export interface DBWallet {
  ...
  externalServerKeyShares: ExternalServerKeyShareJSON | ExternalServerKeyShareJSON[]; // JSONB array or single object
...
export interface WalletRow {
  ...
  external_server_key_shares: ExternalServerKeyShareJSON | ExternalServerKeyShareJSON[]; // JSONB array or single object
